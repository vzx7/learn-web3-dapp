...
import { PolygonQueryResponse, PolygonQueryErrorResponse } from 'components/protocols/polygon/types'
import { CHAINS, POLYGON_NETWORKS, POLYGON_PROTOCOLS } from 'types'
import { getDataHubPolygonNodeUrl } from 'components/protocols/polygon/lib'

export default async function query(
  req: NextApiRequest,
  res: NextApiResponse<PolygonQueryResponse | PolygonQueryErrorResponse>
) {
    const url = getDataHubPolygonNodeUrl(POLYGON_NETWORKS.TESTNET, POLYGON_PROTOCOLS.JSON_RPC)
